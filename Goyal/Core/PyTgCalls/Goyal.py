...
from Goyal import MUSIC_BOT_NAME, app, db_mem, userbot
from Goyal.Core.PyTgCalls import Queues
from Goyal.Core.PyTgCalls.Converter import convert
from Goyal.Core.PyTgCalls.Downloader import download
from Goyal.Database import remove_active_chat
from Goyal.Inline import (audio_markup, audio_timer_markup_start,
