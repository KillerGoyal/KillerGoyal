...
from Goyal.Core.Clients.cli import app, userbot
...
async def initiate_bot():
    ...
    header.add_column(
        "Goyal Music Bot : The Most Advanced Music Bot"
    )
    ...
    with console.status(
        ...
        initial = await startup_send_new("Starting Goyal Music Bot...")
