...
from Goyal import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
                   MUSIC_BOT_NAME, app, db_mem)
from Goyal.Core.PyTgCalls.Converter import convert
from Goyal.Core.PyTgCalls.Downloader import download
from Goyal.Decorators.assistant import AssistantAdd
from Goyal.Decorators.checker import checker
from Goyal.Decorators.permission import PermissionCheck
from Goyal.Inline import (playlist_markup, search_markup, search_markup2,
                          url_markup, url_markup2)
from Goyal.Utilities.changers import seconds_to_min, time_to_seconds
from Goyal.Utilities.chat import specialfont_to_normal
from Goyal.Utilities.stream import start_stream, start_stream_audio
from Goyal.Utilities.theme import check_theme
from Goyal.Utilities.thumbnails import gen_thumb
from Goyal.Utilities.url import get_url
from Goyal.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
@app.on_callback_query(filters.regex(pattern=r"Goyal"))
