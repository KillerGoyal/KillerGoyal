...
from Goyal import ASSID, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Goyal import boottime as bot_start_time
from Goyal import db
from Goyal.Core.PyTgCalls import Goyal
from Goyal.Database import (add_nonadmin_chat, add_served_chat,
...
from Goyal.Decorators.admins import ActualAdminCB
from Goyal.Decorators.permission import PermissionCheck
from Goyal.Inline import (custommarkup, dashmarkup, setting_markup, setting_markup2,
                          start_pannel, usermarkup, volmarkup)
from Goyal.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await Goyal.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"Goyal Disk Usage: {diske}%", show_alert=True
        )
