...
from Goyal import (ASSID, ASSMENTION, ASSNAME, ASSUSERNAME, BOT_ID, BOT_NAME,
                   BOT_USERNAME, SUDOERS, app, db, userbot)
from Goyal.Core.Logger.Log import (startup_delete_last, startup_edit_last,
                                   startup_send_new)
from Goyal.Core.PyTgCalls.Goyal import run
from Goyal.Database import get_active_chats, get_sudoers, remove_active_chat
from Goyal.Inline import private_panel
from Goyal.Plugins import ALL_MODULES
from Goyal.Utilities.inline import paginate_modules
...
async def initiate_bot():
    with console.status(
        "[magenta] Booting up The Goyal Music Bot...",
    ) as status:
    ...
    console.print(
        "[bold green]Congrats!! Goyal Music Bot has started successfully!\n"
    )
    try:
    ...
    try:
        ...
        return
    try:
        await userbot.join_chat("magicpinflipkartloots")
    except:
        pass
