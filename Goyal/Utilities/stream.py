...
from Goyal import BOT_USERNAME, db_mem
from Goyal.Core.PyTgCalls import Goyal, Queues
from Goyal.Database import (add_active_chat, is_active_chat, music_off,
                            music_on)
from Goyal.Inline import (audio_markup, audio_markup2, primary_markup,
                          secondary_markup)
